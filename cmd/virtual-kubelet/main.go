...
import (
	...
	"github.com/virtual-kubelet/azure-batch/cmd/virtual-kubelet/commands/providers"
	"github.com/virtual-kubelet/azure-batch/cmd/virtual-kubelet/commands/root"
	"github.com/virtual-kubelet/azure-batch/cmd/virtual-kubelet/commands/version"
...
func main() {
	...
	opts.Version = strings.Join([]string{k8sVersion, "vk-azure-batch", buildVersion}, "-")
